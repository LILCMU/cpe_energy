...
function cb(start, end) {
		...
		validateParams();
		console.log( moment(start).format('YYYY-MM-DD HH:mm:ss'))
		fetchData({field: 1 ,start : moment(getTimezone(start)).format('YYYY-MM-DD HH:mm:ss'),end : moment(end).format('YYYY-MM-DD HH:mm:ss'),median: 10});
		fetchData({field: 3 ,start : moment(getTimezone(start)).format('YYYY-MM-DD HH:mm:ss'),end : moment(end).format('YYYY-MM-DD HH:mm:ss'),median: 10});
